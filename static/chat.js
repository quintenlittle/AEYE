...
(() => {
  ...
  async function send(text) {
    ...
    // WEATHER REQUIRED-CONTEXT GATE (independent of web policy): the weather tool
    // needs a real city/state the user named — never IP, never a placeholder. If
    // this message asks about weather with no location in it and the weather tool
    // is available, steer the model to ask first rather than emit location="?".
